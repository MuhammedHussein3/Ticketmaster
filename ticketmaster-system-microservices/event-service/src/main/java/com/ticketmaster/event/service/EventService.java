...
public interface EventService {
     ...
     */
    Event createEvent(EventCreateRequest eventCreatedRequest) throws EventCreationException;
     ...
     */
    CompletableFuture<Event>getEvent(Long eventId) throws EventNotFoundException;
    ...
    Event updateEvent(Long eventId, EventUpdateRequest eventUpdateRequest) throws EventNotFoundException;
